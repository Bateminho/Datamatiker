...
public class Gui extends Application {
    ...
    private void fillAction(String input) {
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Manglende information");
        alert.setHeaderText(null);

        String message = switch (input) {
            case "navn" -> "Du mangler at tilføje navn.";
            case "titel" -> "Du mangler at tilføje titel";
            case "navn og titel" -> "Du mangler at tilføje både navn og titel";
            default -> "Ufuldstændig information";
        };
