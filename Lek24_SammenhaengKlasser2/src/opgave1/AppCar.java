...
public class AppCar {
    public static void main(String[] args) {
        ...
        firstCar.addRental(firstRental);
        firstCar.addRental(secondRental);

        secondCar.addRental(secondRental);



        System.out.println("Flest dage en bil har været udlejet: " + firstCar.getMostDays() + " ");

        System.out.println(secondCar.getMostDays());
    }
}
