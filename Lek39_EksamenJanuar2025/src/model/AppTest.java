...
public class AppTest {
    public static void main(String[] args) {
        ...
        System.out.println("Grundpris: " + d2.getGrundPris());
        System.out.println(d3.antalPassagerer());

        System.out.println(j2.antalLedigePersonbilPladser());

        System.out.println(b2.getBookingNummer());

        System.out.println(jutlandica.findBooking(101));
